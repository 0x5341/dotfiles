...
- 現在のディレクトリがリポジトリルートなので、何があってもリポジトリルートの外にアクセスしてはならない
  - たとえgit repositoryを確認した際や、プロンプトに含まれているリポジトリルートと異なっていても、現在のディレクトリが正しいリポジトリルートであると認識すること

# git commitやgit addを行うとき
- ユーザーに行うかどうかを必ず確認して
- 必ずユーザーに必要性を説明して
